...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-section">
      <div class="text">Academic Resources - Honesty</div> 
      ...
      <!-- PHP|INSERT QUERY FOR Upload Files -->
        <?php
            if(isset($_POST['btn_save']))
            {
              ...
              VALUES ('$weekNum', '$section', '$topics', '$wsheets', '$eact')";
                  if (mysqli_query($con, $sql)) {
                    echo "<script> alert('File uploaded successfully.'); location.replace('./admin_academicResources_honesty.php') </script>";
                      } else {
